# 💫 About Me:
💼 I’m currently working on WEBMORE'S DIGITAL MARKETING<br>💻 Expertise: HTML5, CSS3, JavaScript, Java, PHP, Python<br>🌐 Frontend: HTML5, CSS3<br>🗄️ Backend: Node.js<br>📱 Mobile App: Flutter<br> 🕸 AI/ML: Weka<br>📦 Databases: MySQL<br>🚀 Deployment: AWS<br>🎮 Game Engines: Unity<br>🎨 UI/UX: Ps, Pr, Ai, Xd, Id, Figma, Bootstrap, Spline<br>🌱 Currently exploring: Unity, Spline, Node.js, FLutter, Ai, AWS<br>🔧 Software: Visual Studio, Netbeans IDE, Anaconda, Arduino IDE, Linux, Laravel
